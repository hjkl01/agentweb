...
async fn main()->Result<()>{
 ...
 let protected_api=Router::new()
  ...
  .route("/sessions",get(api::list_sessions).post(api::create_session)).route("/sessions/{id}",get(api::get_session).delete(api::delete_session)).route("/sessions/{id}/title",axum::routing::put(api::rename_session)).route("/sessions/{id}/model",axum::routing::put(api::set_session_model))
