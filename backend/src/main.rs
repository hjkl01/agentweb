...
async fn main()->Result<()>{
 ...
 let protected_api=Router::new()
  ...
  .route("/node/versions",get(api_node::node_versions)).route("/node/install",axum::routing::post(api::install_node)).route("/agents/{id}/status",get(api::agent_status)).route("/agents/{id}/models",get(api::agent_models)).route("/agents/{id}/install",axum::routing::post(api::install_agent))
