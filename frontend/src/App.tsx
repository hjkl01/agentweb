...
export function App({sessionId,navigate}:Props){
 ...
 return <div className="app" onClick={()=>c.sessionMenu&&c.setSessionMenu(undefined)}>
  ...
  <AgentCatalog open={c.catalogOpen} agents={c.runtime.agents} node={c.runtime.node} nodeVersion={c.runtime.nodeVersion} installingNode={c.installation.installingNode} installingAgent={c.installation.installingAgent} onClose={()=>c.setCatalogOpen(false)} onNodeVersionChange={c.runtime.setNodeVersion} onInstallNode={c.installation.installNode} onInstallAgent={c.installation.installAgent} onInstallCustomAgent={c.installation.installCustomAgent}/>
