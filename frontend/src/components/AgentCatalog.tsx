  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="agent-panel" onClick={event => event.stopPropagation()}>
        ...
        <div className="modal-head"><div><h3>热门 Agent</h3><p>参考 AionUi 的 Multi-Agent 模式，常用 CLI 可以直接一键安装。AionUi 当前也覆盖 Qwen Code、Gemini CLI、Goose、Cursor、Hermes、Pi 等更多 Agent。citeturn1search0</p></div></div>
